...
<div class="content-highlight" style="min-height: 48px;">
  ...
  <span class="content-text">
    <strong>See also</strong>: <a href="scene-layers.html" class="nav-link">Scene Layers</a> and <a href="map.html" class="nav-link">Map</a> for layers in the software context; and <a href="sgb-features.html" class="nav-link">SGB Features</a> for extended palettes and border supported by SGB models.
  </span>
</div>
