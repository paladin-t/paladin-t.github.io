...
<div class="content-highlight" style="min-height: 48px;">
  ...
  <span class="content-text">
    <strong>See also</strong>: <a href="memory-map.html#vram-memory-map" class="nav-link">VRAM Memory Map</a>; <a href="tiles.html" class="nav-link">Tiles</a>, <a href="map.html" class="nav-link">Map</a>, and <a href="sprite.html" class="nav-link">Sprite</a>; <a href="colored-features.html" class="nav-link">Colored Features</a>; <a href="sgb-features.html" class="nav-link">SGB Features</a>.
  </span>
</div>
